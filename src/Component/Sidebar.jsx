...
export default function Sidebar() {
  return (
    <div className='py-7 px-11 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 justify-center w-full bg-stone-800 lg:gap-x-4 lg:flex lg:flex-col lg:pt-20 lg:max-w-60 lg:h-screen lg:justify-start lg:pl-6'>

  <Link to={'/addProduct'}>
    <button className='flexCenter gap-2 rounded-md bg-red-500 h-14 w-40 medium-16'>
